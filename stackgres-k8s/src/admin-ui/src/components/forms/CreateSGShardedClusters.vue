                    ...
                    <div class="fields">
                        ...
                        <template v-else>
                            ...
                            <div class="fieldsetFooter marginBottom">
                                <a class="addRow" @click="coordinator.configurations.shardingSphere.properties.push({ name: null, value: null})">Add Property</a>
                            </div>
                            ...
                            <fieldset data-fieldset="spec.coordinator.configurations.shardingSphere.authority">
                                ...
                                <div class="repeater">
                                    ...
                                    <div class="fieldsetFooter marginBottom">
                                        <a class="addRow" @click="coordinator.configurations.shardingSphere.authority.users.push({user: {key: null, name: null}, password: {key: null, name: null}})">Add User</a>
                                    </div>
                                </div>
                            </fieldset>
                            ...
                            <fieldset data-fieldset="spec.coordinator.configurations.shardingSphere.mode">
                                ...
                                <div class="fieldsetFooter marginBottom">
                                    <a class="addRow" @click="coordinator.configurations.shardingSphere.mode.properties.push({ name: null, value: null})">Add Property</a>
                                </div>
                                ...
                                <fieldset data-fieldset="spec.coordinator.configurations.shardingSphere.mode.repository">
                                    ...
                                    <template v-if="![null, 'Memory'].includes(coordinator.configurations.shardingSphere.mode.repository.type)">
                                        <fieldset :data-fieldset="'spec.coordinator.configurations.shardingSphere.mode.repository.' + coordinator.configurations.shardingSphere.mode.repository.type + '.serverList'" class="noMargin">
                                            <div class="header" :class="!coordinator.configurations.shardingSphere.mode.repository[coordinator.configurations.shardingSphere.mode.repository.type].serverList.length && 'noBorder'">
                                                <h6>
                                                    Server List
                                            ...
                                            <div class="repeater">
                                                <div class="row" v-for="(server, index) in coordinator.configurations.shardingSphere.mode.repository[coordinator.configurations.shardingSphere.mode.repository.type].serverList" :data-field="'spec.coordinator.configurations.shardingSphere.mode.repository.' + coordinator.configurations.shardingSphere.mode.repository.type + '.serverList'">
                                                    <label>
                                                        Server #{{ index + 1}}
                                                        <a class="addRow delete floatRight" @click="spliceArray(coordinator.configurations.shardingSphere.mode.repository[coordinator.configurations.shardingSphere.mode.repository.type].serverList, index)">
                                                            Delete
                                                        </a>
                                                    </label>
                                                    <input v-model="coordinator.configurations.shardingSphere.mode.repository[coordinator.configurations.shardingSphere.mode.repository.type].serverList[index]" autocomplete="off" :data-field="'spec.coordinator.configurations.shardingSphere.mode.repository.' + coordinator.configurations.shardingSphere.mode.repository.type + '.serverList[' + index + ']'">
                                                </div>
                                            </div>
                                        </fieldset>
                                        <div class="fieldsetFooter marginBottom">
                                            <a class="addRow" @click="coordinator.configurations.shardingSphere.mode.repository[coordinator.configurations.shardingSphere.mode.repository.type].serverList.push(null)">Add Server</a>
                                        </div>
                                    </template>
                                    ...
                                    <div class="fieldsetFooter marginBottom">
                                        <a class="addRow" @click="coordinator.configurations.shardingSphere.mode.repository.properties.push({ name: null, value: null})">Add Property</a>
                                    </div>
                                </fieldset>
                            </fieldset>
                        </template>
    ...
    export default {
        ...
        methods: {
            ...
            setupShardingSphereServerList() {
                const vc = this;
                const repoType = vc.coordinator.configurations.shardingSphere.mode.repository.type;
                if (repoType === 'Memory') {
                    ...
                    vc.$set(vc.coordinator.configurations.shardingSphere.mode.repository, repoType, {
                        'serverList': []
                    });
                }
            }
